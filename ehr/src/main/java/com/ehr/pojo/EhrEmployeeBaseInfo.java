...
public class EhrEmployeeBaseInfo {
    private Integer id;
    ...
    public void setWorkbeginning(String workbeginning) {
        this.workbeginning = workbeginning == null ? null : workbeginning.trim();
    }
    ...
    public void setComputerskills(String computerskills) {
        this.computerskills = computerskills == null ? null : computerskills.trim();
    }
    ...
    public void setComputergrade(String computergrade) {
        this.computergrade = computergrade == null ? null : computergrade.trim();
    }
    ...
    public void setSocialrelationship(String socialrelationship) {
        this.socialrelationship = socialrelationship == null ? null : socialrelationship.trim();
    }
    ...
    public void setDateofentry(String dateofentry) {
        this.dateofentry = dateofentry == null ? null : dateofentry.trim();
    }
}